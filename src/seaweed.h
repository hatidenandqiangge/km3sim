...
/**
  ...
  */
typedef std::multimap<std::string, std::string, std::less<std::string> >
    ev_multimap;
...
/**
  ...
  */
typedef std::map<std::string, ev_multimap::iterator, std::less<std::string> >
    ev_iter_map;
...
class event {
 ...
 public:
  ...
  /**
    ...
    * @param typ event type
    */
  void info(bool& new_r, bool& new_e, unsigned& nr, unsigned& ne,
            unsigned& typ);
