...
// KM3Detector.hh generated by Geant4 Geometry Editor at Thu Apr 04 19:40:34 GMT+03:00 2002  
...
public:
  ...
  G4double detectorMaxz;  //this is the maximum vertical distance of the storeys from the center plus a number of absorpion lengths
  G4double detectorMaxRho;  //this is the maximum orizontal distance of the storeys plus a number of absorption lengths
...
private:
  ...
  G4int ALLSTOREYS[1000000];     //this is used in clustering method of splitSpheres
#endif
private:
