...
public:
  ...
  KM3Cherenkov(const G4String& processName = "KM3Cherenkov",G4ProcessType type = fElectromagnetic);
...
private:
  ...
  long double Posit_Photons_Histo[3002];//20 meters every 1cm from -10m to 20m , and 2 for underflow and overflow
#endif
...
inline
void KM3Cherenkov::SetMaxBetaChangePerStep(const G4double value)
{
